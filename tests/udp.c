...
int main(void)
{
  ...
  udp4_send_pkt(NULL, fd, ncs_inet_addr("192.168.1.34"), ncs_inet_addr("173.194.222.138"), 121, random_u16(), NULL, 0, random_srcport(), 80, false, NULL, 0, 0, false);
  ...
  tcp4_send_pkt(NULL, fd, ncs_inet_addr("192.168.1.34"), ncs_inet_addr("173.194.222.138"), 121, false, NULL, 0, random_srcport(), 80, random_u32(), 0, 0, TCP_FLAG_SYN,
		1024, 0, NULL, 0, (u8*)"kek", 3, 0, false);
